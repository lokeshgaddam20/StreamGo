...
import { Bell, Home, Library, Settings, User, Video, Menu, X } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const NavBar = () => {
    ...
    return (
        <header>
            <nav className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm transition-colors duration-200">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Badge variant="outline" className="hidden sm:flex ml-2 border-purple-500 text-purple-500 dark:text-purple-400 dark:border-purple-400">
                                Beta
                            </Badge>
                        </div>
                                        ...
                                        <DropdownMenuTrigger asChild>
                                            ...
                                            >
                                                <Avatar className="h-8 w-8">
                                                    ...
                                                    <AvatarFallback className="bg-purple-200 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                            ...
                            {session && (
                                <>
                                    ...
                                    <div className="border-t border-gray-200 dark:border-gray-800 pt-2">
                                        ...
                                        <Button
                                            variant="ghost"
                                            className="w-full justify-start px-3 py-2 mt-1 text-red-500 hover:bg-gray-100 dark:hover:bg-gray-800"
                                            onClick={() => {
